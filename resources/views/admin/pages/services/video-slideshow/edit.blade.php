...
@section('main-content-inner')
            ...
            <div class="col-lg-12 col-ml-12">
                <div class="row">
                    ...
                    <div class="col-12 mt-5">
                        <div class="card">
                            <div class="card-body">
                                <form id="product-form" name="product-form" action="{{ route('products-update', ['id'=> $product->id]) }}" method="POST" enctype="multipart/form-data" class="dropzone border-0">
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="custom-select product-service" name="service_id" id="services" data-value="{{ $product->service_id }}">
                                            <option value="1">PHOTO EDTITING</option>
                                    ...
                                    <div class="images-collection">
                                        <input type="hidden" class="product-total-images" name="total_image" value="{{  $product->productImages && $product->service != 4 ? $product->productImages->count() : 1 }}">
                                        <label for="" class="col-form-label">Images</label>
                                        <div class="form-group row">
                                            @if($product->productImages->count() && $product->service_id != 4)
                                                ...
                                                <div class="form-group product-images mr-3">
                                                    <div class="d-flex">
                                                        <div class="mb-3 mr-2 image-item" style="position: relative">
                                                            ...
                                                            <img width="150px" height="150px" class="product-img" src="{{ asset('upload/admin/product/'. $image->file_name_1) }}">
                                                        </div>
                                                        <div class="mb-3 mr-2 image-item" style="position: relative">
                                                            ...
                                                            <img width="150px" height="150px" class="product-img" src="{{ asset('upload/admin/product/'. $image->file_name_2) }}">
                                                        </div>
                                    ...
                                    <div class="videos-collection">
                                        ...
                                        <div class="row">
                                            @if($product->productVideos->count() && $product->service_id ==4)
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            ...
            let service_id = $('.product-service').data('value');
            $('.product-service').val(service_id);
