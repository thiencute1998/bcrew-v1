            ...
            <div class="col-lg-12 col-ml-12">
                <div class="row">
                    ...
                    <div class="col-12 mt-5">
                        <div class="card">
                            <div class="card-body">
                                <form id="demoform" name="demoform" action="{{ route('products-store') }}" method="POST" enctype="multipart/form-data" class="dropzone border-0">
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="name" type="text" value="{{ old('name') }}" id="example-text-input" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="example-search-input" class="col-form-label">Quantity</label>
                                        <input class="form-control" name="quantity" type="number" value="{{ old("quantity") }}" id="example-search-input">
                                    </div>
                                    <div class="form-group">
                        ...
                        $.ajax({
                            ...
                            success: function(result){
                                if (result.code) {
                                    ...
                                    $('.product-message').html("<span>Add success !!!</span>");
